...
from .managerws import WebsocketManager


class FtxWebsocketClient(WebsocketManager):
    _ENDPOINT = 'wss://ftx.com/ws/'

    def __init__(self, _api_key, _api_secret) -> None:
        super().__init__()
        self._trades: DefaultDict[str, Deque] = defaultdict(
            lambda: deque([], maxlen=10000))
        self._fills: Deque = deque([], maxlen=10000)
        self._api_key = _api_key  # TODO: Place your API key here
        self._api_secret = _api_secret  # TODO: Place your API secret here
